import { Avatar, Plus, UserFemale, UserMale } from '@3win/icons';
import { Button } from '@3win/ui-kit/ui';
    ...
    <div className="bg-white dark:bg-white/15 rounded-full  p-1 flex items-stretch gap-2 md:gap-6">
      ...
      <div className="flex flex-1 items-center">
        <div className="font-bold flex flex-col me-3">
          ...
          <span className="whitespace-nowrap font-normal text-sm">Bonus {userBalance?.data.balance}</span>
        </div>
